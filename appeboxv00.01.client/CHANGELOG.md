...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest appeboxv00.01.client -- --template=react  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`appeboxv00.01.client.esproj`).
